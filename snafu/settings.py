# Django settings for snafu project.
...
ROOT_URLCONF = 'snafu.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'snafu.wsgi.application'
...
FIXTURE_DIRS = ( os.path.join(BASEDIR, '../referentiel/fixtures/'), )

if 'djcelery' in INSTALLED_APPS :
    import djcelery
    djcelery.setup_loader()
    MIDDLEWARE_CLASSES = MIDDLEWARE_CLASSES + ('sendim.middleware.CeleryMessageMiddleware',)
